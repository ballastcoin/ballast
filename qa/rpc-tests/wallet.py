...
#   c) node1 mines 32 blocks, so now node 0 has 500000BLST, node 1 has 4250BLST, node2 has none.
#   d) node0 sends 601 BLST to node2, in two transactions (301 BLST, then 300 BLST).
