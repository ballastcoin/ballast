                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ballast Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLST address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ballast: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ballast Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ballast Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ballast"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLST addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLST addresses"));
    ...
    openAction->setStatusTip(tr("Open a ballast: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ballast Core help message to get a list with possible Ballast command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ballast Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ballast network", "", count));
}
...
{
    QString strTitle = tr("Ballast Core"); // default title
