...
/** Utility functions used by the Ballast Qt UI.
 */
namespace GUIUtil
{
...
// Render BLST addresses in monospace font
...
// Parse "ballast:" URI into recipient object, return true on successful parsing
