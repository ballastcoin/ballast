...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Ballast server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ballast features */
        {"ballast", "masternode", &masternode, true, true, false},
        {"ballast", "listmasternodes", &listmasternodes, true, true, false},
        {"ballast", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ballast", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ballast", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ballast", "masternodedebug", &masternodedebug, true, true, false},
        {"ballast", "startmasternode", &startmasternode, true, true, false},
        {"ballast", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ballast", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ballast", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ballast", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ballast", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ballast", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ballast", "mnbudget", &mnbudget, true, true, false},
        {"ballast", "preparebudget", &preparebudget, true, true, false},
        {"ballast", "submitbudget", &submitbudget, true, true, false},
        {"ballast", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ballast", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ballast", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ballast", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ballast", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ballast", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ballast", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ballast", "checkbudgets", &checkbudgets, true, true, false},
        {"ballast", "mnsync", &mnsync, true, true, false},
        {"ballast", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ballast-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5166/\n";
}
