...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ballast Core ballast-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ballast-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ballast transaction") + "\n" +
                               "  ballast-tx [options] -create [commands]   " + _("Create hex-encoded ballast transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ballast transaction
