...
RESOURCES += src/qt/ballast.qrc src/qt/ballast_locale.qrc

TRANSLATIONS += src/qt/locale/ballast_bg.ts \
                src/qt/locale/ballast_de.ts \
                src/qt/locale/ballast_en.ts \
                src/qt/locale/ballast_es.ts \
                src/qt/locale/ballast_fi.ts \
                src/qt/locale/ballast_fr.ts \
                src/qt/locale/ballast_it.ts \
                src/qt/locale/ballast_ja.ts \
                src/qt/locale/ballast_pl.ts \
                src/qt/locale/ballast_pt.ts \
                src/qt/locale/ballast_ru.ts \
                src/qt/locale/ballast_sk.ts \
                src/qt/locale/ballast_sv.ts \
                src/qt/locale/ballast_vi.ts \
                src/qt/locale/ballast_zh_CN.ts \
                src/qt/locale/ballast_zh_TW.ts
