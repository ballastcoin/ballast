Contributing to Ballast Core
==================================

The Ballast Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ballast Core project, and is not to be
confused with overall Ballast Network Protocol consensus changes.

Whether a pull request is merged into Ballast Core rests with the project merge
...
Patches that change Ballast consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ballast consensus, it must have been
...
The project leader is the release manager for each Ballast Core release.
