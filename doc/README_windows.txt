...
Intro
-----
Ballast (BLST) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Ballast utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ballast-qt.exe.

Ballast Core is the original Ballast client and it builds the backbone of the network.
However, it downloads and stores the entire history of Ballast transactions;
