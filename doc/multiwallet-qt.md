...
In order to support loading of multiple wallets in ballast-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ballast.cpp.
...
Changes to ballast.cpp
----------------------
ballast.cpp is the entry point into ballast-qt, and as such, will require some minor modifications to provide hooks for
